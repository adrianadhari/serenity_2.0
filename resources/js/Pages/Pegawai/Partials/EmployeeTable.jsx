...
export default function EmployeeTable({ employees }) {
    ...
    const deleteEmployees = (e) => {
        ...
        post(route("pegawai.multipleDelete"), {
            preserveScroll: true,
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("pegawai.edit", rowData.nik_peserta)}
    ...
    const onSelectionChange = (e) => {
        ...
        setData(
            "codes",
            e.value.map((item) => item.nik_peserta)
        );
    };

    const dateRangeTemplate = (rowData) => {
        return `${rowData.tanggal_mulai} - ${rowData.tanggal_akhir}`;
    };
        ...
        <>
            ...
            <div className="card shadow-lg">
                ...
                >
                    ...
                    <Column sortable field="nik_peserta" header="NIK Peserta" />
                    <Column
                        sortable
                        field="nama_peserta"
                        header="Nama Peserta"
                    ...
                    <Column
                        sortable
                        field="jabatan_saat_pelatihan"
                        header="Jabatan Saat Pelatihan"
                    />
                    <Column
                        sortable
                        field="unit_saat_pelatihan"
                        header="Unit Saat Pelatihan"
                    />
                        ...
                        <table className="table-auto mb-4">
                            <tbody>
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.training.nama_pelatihan}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">NIK Peserta</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.nik_peserta}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.nama_peserta}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                        Jabatan Saat Pelatihan
                                    </td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.jabatan_saat_pelatihan}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.unit_saat_pelatihan}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.jabatan_saat_ini}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Unit Saat Ini</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.unit_saat_ini}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                    ...
                                    <td className="p-2">
                                        {moment(
                                            detailEmployee.masa_berlaku_sertifikat
                                        ).format("D/M/YYYY")}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-2">
                                        {moment(
                                            detailEmployee.masa_berakhir_sertifikat
                                        ).format("D/M/YYYY")}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailEmployee.link_sertifikat}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
