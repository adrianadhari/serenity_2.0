...
export default function EditForm({
    ...
    let { nama, nip, jenis_kelamin, email, telp, jabatan, pendidikan } =
        teacherDetail;
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        jabatan,
        pendidikan,
        school_name: teacherDetail.school.nama_sekolah,
    });

    const updateTeacher = async (e) => {
        e.preventDefault();

        patch(route("guru.update", teacherDetail.kode));
    };

    return (
        <form onSubmit={updateTeacher} className="form-card">
