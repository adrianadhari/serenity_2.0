...
export default function EditForm({ typeData, statusData, publicationDetail }) {
    ...
    let { judul, tipe, haki, status } = publicationDetail;
    ...
    const updatePublication = async (e) => {
        ...
        patch(route("publikasi.update", publicationDetail.kode));
    };

    return (
        <form onSubmit={updatePublication} className="form-card">
