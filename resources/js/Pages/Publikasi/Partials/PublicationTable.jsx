...
export default function PublicationTable({ publications }) {
    ...
    const deletePublication = (e) => {
        ...
        post(route("publikasi.multipleDelete"), {
            preserveScroll: true,
            ...
            onFinish: () => {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Publikasi Berhasil Dihapus",
                });
            },
        });
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("publikasi.edit", rowData.kode)}
        ...
        <>
            ...
            <div className="card shadow-lg">
                <DataTable
                    ...
                    currentPageReportTemplate="Menampilkan {first} sampai {last} dari {totalRecords} publikasi"
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown CurrentPageReport"
                >
                    <Column selectionMode="multiple" />
                    <Column sortable field="kode" header="Kode Publikasi" />
                    <Column sortable field="judul" header="Judul Publikasi" />
                    <Column sortable field="tipe" header="Tipe" />
                    <Column sortable field="haki" header="HAKI" />
                    ...
                    <table className="table-auto">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {detailPublication.tipe}
                                </td>
                            </tr>
                            <tr>
                                <td className="font-bold">HAKI</td>
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {detailPublication.haki}
                                </td>
                            </tr>
                            <tr>
