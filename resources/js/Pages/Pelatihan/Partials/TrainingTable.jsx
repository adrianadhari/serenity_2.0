...
export default function TrainingTable({ trainings }) {
    const [dataTrainings, setDataTrainings] = useState(null);
    ...
    const deletetrainings = (e) => {
        e.preventDefault();

        post(route("pelatihan.multipleDelete"), {
            preserveScroll: true,
            ...
            onFinish: () => {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Pelatihan Berhasil Dihapus",
                });
            },
        });
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("pelatihan.edit", rowData.kode_pelatihan)}
    ...
    const onSelectionChange = (e) => {
        ...
        setData(
            "codes",
            e.value.map((item) => item.kode_pelatihan)
        );
    };

    const dateRangeTemplate = (rowData) => {
        return `${rowData.tanggal_mulai} sampai ${rowData.tanggal_akhir}`;
    };
        ...
        <>
            ...
            <div className="card shadow-lg">
                ...
                >
                    ...
                    <Column sortable field="kode_pelatihan" header="Kode" />
                    <Column
                        sortable
                    ...
                    <Column
                        sortable
                        field="institusi"
                        header="Institusi Pemberi Pelatihan"
                    />
                    <Column
                        sortable
                        ...
                        <table className="table-auto mb-4">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTraining.nama_pelatihan}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                        Institusi Pemberi Pelatihan
                                    </td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTraining.institusi}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className="font-bold">Unit Pengusul</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTraining.unit_pengusul}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
