...
export default function EditForm({
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        doi,
        status_penelitian,
        institusi: researchDetail.institution.nama,
        publikasi: researchDetail.publication.judul,
    });

    const updateResearch = async (e) => {
        e.preventDefault();

        patch(route("penelitian.update", kode_penelitian));
    };

    return (
        <form onSubmit={updateResearch} className="form-card">
