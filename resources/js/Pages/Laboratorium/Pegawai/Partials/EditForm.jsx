...
export default function EditForm({ gender, study, pegawaiDetail }) {
    ...
    const updatePegawai = async (e) => {
        ...
        patch(route("lab.pegawai.update", pegawaiDetail.kode));
    };

    return (
        <form onSubmit={updatePegawai} className="form-card">
