...
export default function PegawaiTable({ employees }) {
    const [dataEmployees, setDataEmployee] = useState(null);
    ...
    const deletePegawai = (e) => {
        ...
        post(route("lab.pegawai.multipleDelete"), {
            preserveScroll: true,
            ...
            onFinish: () => {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Pegawai Berhasil Dihapus",
                });
            },
        });
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("lab.pegawai.edit", rowData.kode)}
        ...
        <>
            ...
            <div className="card shadow-lg">
                ...
                >
                    ...
                    <Column sortable field="kode" header="Kode Pegawai" />
                    <Column sortable field="nama" header="Nama Pegawai" />
                    <Column sortable field="nip" header="NIP" />
            ...
            >
                {detailEmployee && (
                    <table className="table-auto">
                        <tbody>
                            <tr>
                                <td className="font-bold">Kode Pegawai</td>
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.kode}</td>
                            </tr>
                            <tr>
                                <td className="font-bold">Nama Pegawai</td>
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.nama}</td>
                            </tr>
                            <tr>
                                <td className="font-bold">NIP</td>
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.nip}</td>
                            </tr>
                            <tr>
                                <td className="font-bold">Jabatan</td>
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {detailEmployee.jabatan}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {moment(detailEmployee.tgl_lahir).format(
                                        "D/MM/YYYY"
                                    )}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.telp}</td>
                            </tr>
                            <tr>
                                <td className="font-bold">Email</td>
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.email}</td>
                            </tr>
                            <tr>
                                <td className="font-bold">Alamat</td>
                                <td className="p-2">:</td>
                                <td className="p-2">{detailEmployee.alamat}</td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {moment(detailEmployee.created_at).format(
                                        "D/MM/YYYY"
                                    )}
                                </td>
                            </tr>
