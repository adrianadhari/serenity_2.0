...
export default function PraAnalisaTable({ praAnalisas }) {
    ...
    const deleteAction = (e) => {
        ...
        post(route("lab.pra-analisa.multipleDelete"), {
            preserveScroll: true,
            ...
            onFinish: () => {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Data Pra Analisa Berhasil Dihapus",
                });
            },
        });
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                <Link
                    href={route("lab.pra-analisa.show", rowData.kode)}
                ...
                <Link
                    href={route("lab.pra-analisa.edit", rowData.kode)}
    ...
    const onSelectionChange = (e) => {
        ...
        setData(
            ...
            e.value.map((item) => ({
                ...
                surat_balasan: item.surat_balasan,
                invoice_dp: item.invoice_dp,
                bukti_bayar_dp: item.bukti_bayar_dp,
                permintaan_tender: item.permintaan_tender,
                sppc: item.sppc,
                buku_agenda: item.buku_agenda,
            }))
        );
    };
        ...
        <>
            ...
            <div className="card shadow-lg">
                <DataTable
                    ...
                    currentPageReportTemplate="Menampilkan {first} sampai {last} dari {totalRecords} data pra analisa"
                ...
                >
                    ...
                    />
                    <Column sortable field="pelayanan" header="Pelayanan" />
                    <Column
                        sortable
                        field="jenis_analisis"
