...
export default function StudentTable({ tools }) {
    ...
    const deleteTools = (e) => {
        ...
        post(route("lab.alat.multipleDelete"), {
            preserveScroll: true,
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("lab.alat.edit", rowData.kode_alat)}
    ...
    const onSelectionChange = (e) => {
        ...
        setData(
            "codes",
            e.value.map((item) => item.kode_alat)
        );
    };
        ...
        <>
            ...
            <div className="card shadow-lg">
                ...
                >
                    ...
                    <Column sortable field="kode_alat" header="Kode Alat" />
                    <Column
                        sortable
                        field="kategori_alat"
                        header="Kategori Alat"
                    />
                    <Column sortable field="nama_alat" header="Nama Alat" />
                    <Column sortable field="merk" header="Merk" />
                ...
                {detailTool && (
                    <>
                        <table className="table-auto mb-4">
                            <tbody>
                                <tr>
                                    <td className="font-bold">Kode Alat</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.kode_alat}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Kategori Alat</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.kategori_alat}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.nama_alat}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Merk</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">{detailTool.merk}</td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Nomor Serial</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.nomor_serial}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.deskripsi_alat}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Status BMN</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.status_bmn}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Kode BMN</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.kode_bmn}
                                    </td>
                                ...
                                <tr>
                                    <td className="font-bold">Sumber Dana</td>
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.sumber_dana}
                                    </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">
                                ...
                                <tr>
                                    ...
                                    <td className="p-2">:</td>
                                    <td className="p-2">
                                        {detailTool.keterangan_service_terakhir}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
