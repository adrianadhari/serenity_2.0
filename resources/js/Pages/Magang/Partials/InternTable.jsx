...
export default function InternTable({ interns }) {
    const [dataInterns, setDataInterns] = useState(null);
    const [deleteModal, setDeleteModal] = useState(false);
    const [detailDataModal, setDetailDataModal] = useState(false);
    const [dataIntern, setDataIntern] = useState(null);
    const [selectedDatas, setSelectedDatas] = useState(null);
    const [globalFilter, setGlobalFilter] = useState(null);
    const toast = useRef(null);

    useEffect(() => {
        setDataInterns(interns);
    }, [interns]);
    ...
    const deleteInterns = (e) => {
        e.preventDefault();

        post(route("magang.multipleDelete"), {
            preserveScroll: true,
            ...
            onFinish: () => {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Magang Berhasil Dihapus",
                });
            },
        });
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex items-center gap-1">
                ...
                <Link
                    href={route("magang.edit", rowData.kode)}
    ...
    const dateFinishTemplate = (rowData) => {
        return formatDate(rowData.finish);
    };
        ...
        <>
            ...
            <div className="card shadow-lg">
                <DataTable
                    ...
                    currentPageReportTemplate="Menampilkan {first} sampai {last} dari {totalRecords} internship"
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown CurrentPageReport"
                >
                    <Column selectionMode="multiple" />
                    <Column sortable field="student.nis" header="NIS" />
                    <Column
                        sortable
                        field="student.nama_siswa"
                        header="Nama Siswa"
                    />
                    <Column
                        sortable
                    ...
                    <table className="table-auto mb-4">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {dataIntern.student.jenis_kelamin}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="p-2">:</td>
                                <td className="p-2">
                                    {formatDate(dataIntern.created_at)}
                                </td>
                            </tr>
                        </tbody>
                    </table>
