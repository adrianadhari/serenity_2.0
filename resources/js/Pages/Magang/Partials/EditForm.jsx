...
export default function EditForm({ students, internDetail }) {
    ...
    let { start, finish } = internDetail;

    const { data, setData, patch, processing, errors } = useForm({
        start,
        finish,
        nis: internDetail.student.nis,
    });

    const updateIntern = async (e) => {
        e.preventDefault();

        patch(route("magang.update", internDetail.kode));
    };

    return (
        <form onSubmit={updateIntern} className="form-card">
