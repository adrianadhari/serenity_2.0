        ...
        <div className="drawer-side z-20">
            ...
            <div className="py-4 text-gray-500 bg-white min-h-screen">
                ...
                <ul className="mt-6">
                    ...
                    {adminOrLab && (
                        <NavLink
                            href={route("dashboard-laboratorium")}
                            active={route().current("dashboard-laboratorium")}
                        >
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                            ...
                            <span className="ml-4">Dashboard Laboratorium</span>
                        </NavLink>
                    )}
                    ...
                    {adminOrLab && (
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                ...
                                <Dropdown.Link
                                    href={route("lab.pra-analisa.index")}
                                >
                                    Data Pra Analisa
                                </Dropdown.Link>
                                <Dropdown.Link
